(function (w, d) {
    ...
    var Blog = {
        ...
        modal: function (target) {
            ...
            this.show = function () {
                // Below if block is used to disable mask, when target is '#stickyNoteWrap';
                if(target != '#stickyNoteWrap') {
                    mask.classList.add('in');
                }
        ...
        note: function () {
            var noteWrapModal = new this.modal('#stickyNoteWrap');
            $('#noteBtn').addEventListener(even, noteWrapModal.toggle);
        },
    ...
    if (w.BLOG.SHARE) {
        Blog.share()
        //Blog.note would be extracted out of this if block;
        Blog.note()
    }
