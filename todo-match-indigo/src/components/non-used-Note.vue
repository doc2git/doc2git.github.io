        ...
        <ul class="todo-list">
            ...
            >
                <div class="view">
                    ...
                    >
                    <label @dbclick="edtiTodo(todo)">{{ todo.title }}</label>
...
<script>
    Array.prototype.descById = function () {
    ...
    var app = new Vue({ // app initial state
        ...
        computed: {
            filteredTodos: function () {
                return filters[this.visibility](this.todos).descById();
            },
            remaining: function () {
        ...
        // note there's no DOM mainpulation here at all;
        methods: {
            addTodo: function () {
        ...
        // before forcusing on the input field;
        directives: {
...
<style>
    ...
    .footer:before {
        ...
        0 16px 0 -6px rgba(0, 0, 0, .2),
        0 17px 0 -6px rgba(0, 0, 0, .2);
    }
